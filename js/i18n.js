...
const LOCALES = {
    en: {
        ...
        'modal.infoBody2': 'Addition uses three helpers: Direct, the Little Friend (5-complement), and the Big Friend (10-complement) with a carry. Each step shows a rule, finger movement, and current value.',
        'modal.infoBody3': 'Subtraction uses Direct, the Little Friend (5-complement), or a Borrow with the Big Friend (10-complement). A blue flash indicates borrow, a green flash indicates carry.',
        'modal.gotIt': 'Got it',
    ...
    ms: {
        ...
        'modal.infoBody2': 'Penambahan guna tiga kaedah: Terus, Kawan Kecil (pelengkap 5), dan Kawan Besar (pelengkap 10) dengan bawa. Setiap langkah menunjukkan peraturan, pergerakan jari, dan nilai semasa.',
        'modal.infoBody3': 'Penolakan guna Terus, Kawan Kecil (pelengkap 5), atau Pinjam dengan Kawan Besar (pelengkap 10). Kilat biru menandakan pinjam, kilat hijau menandakan bawa.',
        'modal.gotIt': 'Faham',
