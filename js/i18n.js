...
const LOCALES = {
    en: {
        ...
        'update.versions': 'Installed: v{{current}} · Latest: {{latest}}',
        ...
        'update.upToDateText': 'Hand Math v{{current}} is the latest version.',
        'update.checkFailedTitle': 'Update check failed',
        'update.checkFailedText': 'Could not reach GitHub. Check your internet connection and try again.',
        'update.rateLimitedText': 'GitHub is limiting update checks from your network right now. Please try again in a little while.',
        'update.retry': 'Retry',
        'update.checkButton': 'Check for updates',
        'update.checkTooltip': 'Check GitHub for a newer release',
        ...
        'tour.back': 'Back',
        'tour.skip': 'Skip',
        'help.startTourPrompt': 'Want a guided tour of the app?',
    ...
    ms: {
        ...
        'aria.level': 'Tahap',
        'aria.close': 'Tutup',
        'update.availableTitle': 'Kemas kini tersedia',
        'update.versions': 'Dipasang: v{{current}} · Terkini: {{latest}}',
        'update.releaseNotes': 'Nota keluaran',
        'update.noNotes': 'Tiada nota keluaran disediakan.',
        'update.download': 'Muat turun kemas kini',
        'update.releasePage': 'Halaman keluaran',
        'update.skip': 'Langkau versi ini',
        'update.upToDateTitle': 'Anda sudah terkini',
        'update.upToDateText': 'Hand Math v{{current}} ialah versi terkini.',
        'update.checkFailedTitle': 'Semakan kemas kini gagal',
        'update.checkFailedText': 'Tidak dapat menghubungi GitHub. Semak sambungan internet anda dan cuba lagi.',
        'update.rateLimitedText': 'GitHub sedang menghadkan semakan kemas kini dari rangkaian anda buat sementara waktu. Sila cuba lagi sebentar lagi.',
        'update.retry': 'Cuba lagi',
        'update.checkButton': 'Semak kemas kini',
        'update.checkTooltip': 'Semak GitHub untuk keluaran baharu',
        ...
        'tour.back': 'Kembali',
        'tour.skip': 'Langkau',
        'help.startTourPrompt': 'Mahu lawatan berpandu untuk aplikasi ini?',
